...
- Support [#20]: discontinue use of `pkg_resources` due to its long import time. Symlink `sdsstools._vendor.releases` to `sdsstools.releases` to avoid having to load it on import.
